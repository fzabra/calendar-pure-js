...
function createMonth() {
    ...
    console.log(dateObject.getDate(), dayOfWeekAsString(dateObject.getDay()), monthsAsString(dateObject.getMonth()), dateObject.getFullYear())
    ...
    console.log(monthsAsString(date.getMonth()) + " " + date.getFullYear());
    getCurrentDay();
}
...
function getCurrentDay() {
    ...
    currentDay = today + "-" + thisMonth + "-" + currentYear;
    currentDay.className = "calendar-day today";
    console.log("DIA-MES-ANO HOJE >> ", currentDay);
    console.log("DIA-MES-ANO HOJE >> ", currentDay);
}
